  ...
  function init(context) {
    ...
    function toggleInformationArea(e) {
      if (e.currentTarget.id === "fabEditInfoStandard") {
        _toggleInformationItem(ctx.$.showInfoStandard, "show-info", "edit-info", e.currentTarget);
        _toggleInformationItem(ctx.$.editInfoStandard, "show-info", "edit-info", e.currentTarget);
      } else {
        _toggleInformationItem(ctx.$.showInfoBio, "show-info", "edit-info", e.currentTarget);
        _toggleInformationItem(ctx.$.editInfoBio, "show-info", "edit-info", e.currentTarget);
      }
    }
    /**
